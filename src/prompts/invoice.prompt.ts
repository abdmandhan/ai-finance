...
function parseInvoicePrompt(): string {
  return [
    ...
    '  "delete_retainer", or "list_retainers" for customer retainer memory; "unsupported" only',
...
function classifyPrompt(): string {
  return [
    ...
    '- "invoice": creating, amending, or managing retainers for sales invoices, or creating a supplier bill/expense in Xero.',
