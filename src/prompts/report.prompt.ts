...
function parseReportPrompt(today: string): string {
  return [
    ...
    "  unpaid_invoices | overdue_invoices | draft_invoices | paid_invoices |",
    "  voided_invoices (customer/sales side; 'draft invoices' means ACCREC customer invoices);",
    "  unpaid_bills | overdue_bills | draft_bills | paid_bills | voided_bills |",
    "  bills_due_soon (supplier side, money the user owes);",
